...
const (
	...
	AuthService_SSOLogin_FullMethodName       = "/auth.AuthService/SSOLogin"
	...
	AuthService_ClientInfo_FullMethodName     = "/auth.AuthService/ClientInfo"
)
...
func (c *authServiceClient) SSOLogin(ctx context.Context, in *SSOLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, AuthService_SSOLogin_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ConfirmEmail(ctx context.Context, in *ConfirmEmailRequest, opts ...grpc.CallOption) (*ConfirmEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthService_ConfirmEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) ClientInfo(ctx context.Context, in *ClientInfoRequest, opts ...grpc.CallOption) (*ClientInfoResponse, error) {
	out := new(ClientInfoResponse)
	err := c.cc.Invoke(ctx, AuthService_ClientInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) SSOLogin(context.Context, *SSOLoginRequest) (*LoginResponse, error) {
...
func (UnimplementedAuthServiceServer) ClientInfo(context.Context, *ClientInfoRequest) (*ClientInfoResponse, error) {
...
func _AuthService_SSOLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SSOLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).SSOLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_SSOLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).SSOLogin(ctx, req.(*SSOLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_ClientInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ClientInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).ClientInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_ClientInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).ClientInfo(ctx, req.(*ClientInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SSOLogin",
			Handler:    _AuthService_SSOLogin_Handler,
		},
		{
			MethodName: "Register",
		...
		},
		{
			...
			Handler:    _AuthService_ClientInfo_Handler,
		},
	},
